...
> * [中文](./cdn-how-to-create-LiveStreaming-CDN-endpoint.md)
> * [English](./cdn-enus-how-to-create-LiveStreaming-CDN-endpoint.md) 
...
Azure CDN Live Streaming Acceleration is principally based on the HTTP Live Streaming (HLS) protocol and supports Azure’s built-in [Media Services](https://www.azure.cn/home/features/media-services/).
...
This article is about creating domain names for Streaming Media Acceleration. You can also refer to [Using Azure CDN](./cdn-enus-how-to-use.md) to find out about the basics of creating Azure CDN acceleration nodes.
